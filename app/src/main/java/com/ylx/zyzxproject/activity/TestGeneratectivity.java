...
public class TestGeneratectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("赵涌在线", BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150));
            }
    ...
    private void createChineseQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.drawable.logo);
                return QRCodeEncoder.syncEncodeQRCode("赵涌在线", BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"), logoBitmap);
            }
    ...
    private void createEnglishQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.drawable.logo);
                return QRCodeEncoder.syncEncodeQRCode("赵涌在线", BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.BLACK, Color.WHITE, logoBitmap);
            }
